...
cat > list.txt <<EOF
vless://$UUID@$IP:$vless_port?encryption=none&flow=xtls-rprx-vision&security=reality&sni=paypal.com&fp=chrome&pbk=$public_key&type=tcp&headerType=none#$NAME-reality
