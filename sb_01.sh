  ...
  cat > config.json << EOF
{
  ...
  "dns": {
    ...
    },
    {
        ...
        "tls": {
            "enabled": true,
            "server_name": "maps.apple.com",
            "reality": {
                "enabled": true,
                "handshake": {
                    "server": "maps.apple.com",
                    "server_port": 443
                },
...
cat > list.txt <<EOF
vless://$UUID@$IP:$vless_port?encryption=none&flow=xtls-rprx-vision&security=reality&sni=maps.apple.com&fp=chrome&pbk=$public_key&type=tcp&headerType=none#$NAME-reality
